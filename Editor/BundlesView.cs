...
namespace Oddworm.EditorFramework.BuildLayoutExplorer
{
    ...
    public class BundlesView : BuildLayoutView
    {
        ...
        {
            if (target is BuildLayout.Bundle)
                return true;
        ...
        public override void NavigateTo(object target)
        {
            ...
            var bundle = target as BuildLayout.Bundle;
            if (bundle == null)
        ...
        {
            m_ReferencesToView.ShowReferences(Utility.GetReferencesTo(buildLayout, item.GetObject()));
            m_ReferencedByView.ShowReferences(Utility.GetReferencedBy(buildLayout, item.GetObject()));
        }
